...
- **`xwiki:18.7.0-postgres-tomcat` was rebuilt upstream**; the pin moved from `sha256:3827ef79cbeb…` to `sha256:1dc2fa1494f6…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
- **`xwiki:18.7.0-postgres-tomcat` was rebuilt upstream**; the pin moved from `sha256:d551b75d3066…` to `sha256:3827ef79cbeb…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
- **`xwiki:18.7.0-postgres-tomcat` was rebuilt upstream**; the pin moved from `sha256:6091aec4bacb…` to `sha256:d551b75d3066…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.

## [1.8.1] - 2026-09-09

### Security

- **`xwiki:18.7.0-postgres-tomcat` was rebuilt upstream**; the pin moved from `sha256:93765c7c69ec…` to `sha256:6091aec4bacb…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
[Unreleased]: https://github.com/heyvaldemar/xwiki-traefik-letsencrypt-docker-compose/compare/v1.8.7...HEAD
...
[1.8.0]: https://github.com/heyvaldemar/xwiki-traefik-letsencrypt-docker-compose/compare/v1.7.0...v1.8.0
[1.7.0]: https://github.com/heyvaldemar/xwiki-traefik-letsencrypt-docker-compose/compare/v1.6.0...v1.7.0
[1.6.0]: https://github.com/heyvaldemar/xwiki-traefik-letsencrypt-docker-compose/compare/v1.5.0...v1.6.0
[1.5.0]: https://github.com/heyvaldemar/xwiki-traefik-letsencrypt-docker-compose/compare/v1.4.0...v1.5.0
[1.4.0]: https://github.com/heyvaldemar/xwiki-traefik-letsencrypt-docker-compose/compare/v1.3.0...v1.4.0
[1.3.0]: https://github.com/heyvaldemar/xwiki-traefik-letsencrypt-docker-compose/compare/v1.2.0...v1.3.0
[1.2.0]: https://github.com/heyvaldemar/xwiki-traefik-letsencrypt-docker-compose/compare/v1.1.0...v1.2.0
